        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
            @php
                $links = [
                    ...
                    ['title' => 'Deals', 'icon' => 'heroicon-s-currency-dollar', 'color' => 'white', 'bg' => '#22c55e'],
                    ['title' => 'Calendar', 'icon' => 'heroicon-s-calendar', 'color' => 'white', 'bg' => '#4b5563'],
                    ['title' => 'Reports', 'icon' => 'heroicon-s-document-chart-bar', 'color' => 'white', 'bg' => '#eab308'],
                    ['title' => 'Team', 'icon' => 'heroicon-s-users', 'color' => 'white', 'bg' => '#9a3412'],
                    ['title' => 'Approvals', 'icon' => 'heroicon-s-check-badge', 'color' => 'white', 'bg' => '#ef4444'],
                ];
            @endphp
