<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-neutral-900">Daftar ke Smart CRM</h1>
        <p class="mt-2 text-sm text-neutral-500">Masukkan data kamu untuk bergabung di SmartCRM.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" x-data="{ password: '', showPassword: false, showConfirmPassword: false }">
        ...
        <div class="mt-5">
            ...
            <x-text-input id="email" class="block mt-1.5 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="nama@example.com" />
    ...
    <p class="mt-6 text-center text-sm text-neutral-500">
        Sudah punya akun?
        <a href="{{ route('login') }}" class="font-semibold text-primary-500 hover:text-primary-600 transition-colors">Masuk</a>
    </p>
</x-guest-layout>
