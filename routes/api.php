...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('can:View:Analytics')->prefix('analytics')->group(function () {
            ...
            Route::get('/by-product', [AnalyticsController::class, 'revenueByProduct']);
            Route::get('/by-region', [AnalyticsController::class, 'revenueByRegion']);
            Route::get('/sales-performance', [AnalyticsController::class, 'salesPerformance']);
            Route::get('/sales-performance/export/csv', [AnalyticsController::class, 'exportSalesPerformance']);
        });
    });
